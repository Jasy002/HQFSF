...
class QuantumPipeline:
    ...
    def __init__(
        ...
        logger.info("QuantumPipeline initialized.")
    ...
    def run(
        ...
        for sample in X:
            ...
            circuit = self.circuit_builder.build(sample)

            circuit = self.circuit_builder.measure(circuit)

            counts = self.measurement.counts(circuit)
        ...
        importance_scores = np.abs(expectation_values)
